...
#define SYSCALL_REM           	(21)
#define SYSCALL_OPEN          	(22)
#define SYSCALL_LISTDIR       	(23)
#define SYSCALL_RWDIR         	(24)
#define SYSCALL_CHDIR         	(25)
#define SYSCALL_MKDIR         	(26)
#define SYSCALL_UNLINK        	(27)
#define SYSCALL_MV            	(28)
#define SYSCALL_CP            	(29)
#define SYSCALL_MOUNT         	(30)
#define SYSCALL_UNMOUNT       	(31)
#define SYSCALL_POPEN         	(32)
#define SYSCALL_DOPEN         	(33)
#define SYSCALL_FLUBBER       	(34)
#define SYSCALL_SET_PORT_DIRS 	(35)
#define SYSCALL_READ_PORT     	(36)
#define SYSCALL_WRITE_PORT    	(37)
