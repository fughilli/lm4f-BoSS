...
#define SYSCALL_POPEN         	(16)
#define SYSCALL_FOPEN         	(17)
#define SYSCALL_MOUNT         	(18)
#define SYSCALL_UNMOUNT       	(19)
#define SYSCALL_FLUBBER       	(20)
#define SYSCALL_SET_PORT_DIRS 	(21)
#define SYSCALL_READ_PORT     	(22)
#define SYSCALL_WRITE_PORT    	(23)
